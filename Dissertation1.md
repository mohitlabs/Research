...
## Abstract
In this paper, we will discuss about the Emotionally Intelligent Machines(EIM's) which is the new field of research in Artificial Intelligence but it has a great potential to do immense good, however the technology can be misused but it is up to the consumers of this technology who will decide whether the technology will be used for good or for evil. This paper describes that how Emotionally Intelligent Machines(EIM's) & Sentiment Synthesis can be developed by using the concept of Ancient Vedic Astrology.
